...
**What to watch for:** The terminal will show results for each rate tested. Look for where throughput plateaus—that's your max capacity.
...
The analysis will output directly in the CLI as well as the llm_analysis.md file.

NOTE: If you would like a different type of summary, you can edit the user prompt section in the above script.
