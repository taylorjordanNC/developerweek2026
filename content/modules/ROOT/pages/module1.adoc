...
This command will take a few seconds to process.
...
Press kbd:[Esc] to exit input mode. Then save:
...
If you don't already have a second terminal window open, do it now and ssh again into the provided workshop instance. Run the following command:
...
When you're ready, exit chat by pressing kbd:[CTRL+C]
